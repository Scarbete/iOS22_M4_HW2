...
class SignUpVC: UIViewController {
    ...
    private lazy var footerView: FooterView = {
        let view = FooterView()
        view.footerButton.addTarget(self, action: #selector(footerSignInTapped), for: .touchUpInside)
        view.setupButtonText(text: "Sign In")
        return view
    }()
    ...
    @objc func signUpButtonTapped(_ sender: UIButton) {
        ...
        let isInputsHasText = fullNameForm.isInputHasText && mobileNumberForm.isInputHasText &&
            emailForm.isInputHasText && userNameForm.isInputHasText &&
            passwordForm.isInputHasText && confirmPasswordForm.isInputHasText
